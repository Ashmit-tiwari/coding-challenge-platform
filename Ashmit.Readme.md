...
<p>
  ...
  <img src="https://img.shields.io/badge/Machine%20Learning-3b82f6?style=for-the-badge&logo=scikitlearn&logoColor=white" alt="Machine Learning" />
</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/REST_APIs-6366f1?style=for-the-badge&logo=fastapi&logoColor=white" alt="REST APIs" />
</p>
...
graph LR
    ...
    C --> D[Backend & Database Systems]
    D --> E[Full-Stack Architecture]
    E --> F[Machine Learning Foundations]
    F --> G[Deep Learning & Neural Networks]
    G --> H[End-to-End AI Engineering]
    
    style A fill:#1e1b4b,stroke:#6366f1,stroke-width:2px,color:#fff
    style B fill:#1e1b4b,stroke:#6366f1,stroke-width:2px,color:#fff
    style C fill:#1e1b4b,stroke:#6366f1,stroke-width:2px,color:#fff
    style D fill:#311042,stroke:#a855f7,stroke-width:2px,color:#fff
    style E fill:#311042,stroke:#a855f7,stroke-width:2px,color:#fff
    style F fill:#0f2b38,stroke:#06b6d4,stroke-width:2px,color:#fff
    style G fill:#0f2b38,stroke:#06b6d4,stroke-width:2px,color:#fff
    style H fill:#134e4a,stroke:#10b981,stroke-width:2px,color:#fff
```
